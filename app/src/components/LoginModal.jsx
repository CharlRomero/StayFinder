  ...
  return (
    <Modal className="Modal" active={props.active} toggle={props.toggle}>
      <section className="Modal-logheader">
        <svg className="Modal-logbtnClose" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" onClick={props.toggle}>
      ...
      <form action="" className="Modal-logform">
        <input type="email" className="Modal-loginput" placeholder="Correo electrónico" />
        <input type="password" className="Modal-loginput" placeholder="Contraseña"/>
      </form>
